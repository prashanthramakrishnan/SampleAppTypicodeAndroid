...
import com.prashanth.sampleapp.BuildConfig
...
class NetworkDaggerModule(private val url: String) {
    ...
    @Provides
    @Singleton
    internal fun provideSampleResultsAPI(retrofit: Retrofit): SampleResultsAPI {
        return retrofit.create(SampleResultsAPI::class.java)
    }
